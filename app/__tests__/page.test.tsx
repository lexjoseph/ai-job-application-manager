...
describe('Home', () => {
  ...
  it('adds a new application and updates the list', async () => {
    ...
    expect(screen.getByText('Test Company - Test Role - Applied')).toBeInTheDocument()
  })
  ...
  it('adds multiple applications and displays them in reverse order', async () => {
    ...
    expect(listItems[0]).toHaveTextContent('Company 2 - Role 2 - Applied')
    expect(listItems[1]).toHaveTextContent('Company 1 - Role 1 - Applied')
  })
})