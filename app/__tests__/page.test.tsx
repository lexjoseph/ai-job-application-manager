...
describe('Home', () => {
  it('renders the title', () => {
    ...
    expect(screen.getByText('My Personal AI Job Application Tracker')).toBeInTheDocument()
  })
  ...
  it('adds a new application and updates the list', async () => {
    ...
    expect(screen.getByText('Test Company - Test Role - Applied - 2023-10-01')).toBeInTheDocument()
  })
  ...
  it('adds multiple applications and displays them in reverse order', async () => {
    ...
    expect(listItems[0]).toHaveTextContent('Company 2 - Role 2 - Applied - 2023-10-02')
    expect(listItems[1]).toHaveTextContent('Company 1 - Role 1 - Applied - 2023-10-01')
  })
})